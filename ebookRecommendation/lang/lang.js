const messages = {
  en: {
    message: {
      ...
      applying_remember_user_info: 'Remember the user info',
      applying_remember_user_info_note: 'Please do not click when using public computer',
  ...
  local: {
    message: {
      ...
      applying_remember_user_info: '记住读者信息',
      applying_remember_user_info_note: '请不要在公共电脑记住读者信息',
      applying_submit: '提交',
